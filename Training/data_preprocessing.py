...
history = model.fit_generator(batch_generator(X_train, y_train, 1000, 1),
                                  steps_per_epoch=300,
                                  epochs=15,
                                  validation_data=batch_generator(X_valid, y_valid, 1000, 0),
                                  validation_steps=200,
                                  verbose=1,
                                  shuffle = 1)


# print('Training MSE:', history.history['mse'])
# print('Validation MSE:', history.history['val_mse'])
